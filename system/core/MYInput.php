...
class Input {
  ...
  private static function cleanInputData($str) {
    ...
    $str = MYSecurity::removeInvisibleCharacters($str, false);
  ...
  private static function fetchFromArray(&$array, $index = null, $xssClean = null) {
    ...
    return $xssClean ? MYSecurity::xssClean($value) : $value;
  }
  ...
  public static function putFormData($index = null, $xssClean = true) {
    ...
    $puts = $xssClean ? array_map(function($put) { return MYSecurity::xssClean($put); }, $puts) : $puts;
